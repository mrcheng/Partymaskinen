...
yepnope({
	load: [
		baseUrl + "css/partymaskinen2.css",
		baseUrl + "deps/json2.js", 
		"http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js",
		baseUrl + "deps/jquery.ba-postmessage.js",
  		baseUrl + "scripts/jquery.shuffle.js",
		baseUrl + "scripts/partymachine.participants.js",
		...
		baseUrl + "scripts/partymachine.controller.boomstick.js",
  		baseUrl + "scripts/partymachine.pluginrunner.js",
  		baseUrl + "scripts/soundmanager2.js",
  		baseUrl + "scripts/partymachine.media.youtube.js",
  		baseUrl + "scripts/partymachine.media.sound.js",
  		baseUrl + "scripts/partymachine.media.js",
  		baseUrl + "scripts/jquery.fittext.js",
  		baseUrl + "scripts/partymachine.js"
	],
	complete: function () {
		partyMachineHost();
  }
