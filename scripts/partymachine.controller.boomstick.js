...
(function (boomstick, partyMachineControllers, $, undefined) {
	...
	if (!boomstickplugin) {
		...
		boomstickplugin.onreadystatechange = function(x) {
			if (boomstickplugin.readyState === 4) {
				if (!boomstickplugin.joysticksJSON) {
				    displayInstallPrompt("Your browser does not yet handle joysticks, please click here to install the Boomstick plugin!<br/>How to run: chrome.exe --always-authorize-plugins --enable-plugins --allow-outdated-plugins", "https://github.com/STRd6/Boomstick/wiki");
				}
			}
		};
		...
		if (!(boomstickplugin != null && boomstickplugin.joysticksJSON)) {
			promptElement = displayInstallPrompt("Your browser does not yet handle joysticks, please click here to install the Boomstick plugin!<br/>How to run: chrome.exe --always-authorize-plugins --enable-plugins --allow-outdated-plugins", "https://github.com/STRd6/Boomstick/wiki");
